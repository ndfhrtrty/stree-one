...
[![Deploy](https://www.herokucdn.com/deploy/button.png)](https://dashboard.heroku.com/new?template=https://github.com/ndfhrtrty/stree-one ) 
...
|端口|443|
|默认UUID|96d61823-2492-45a6-87bb-40ba1e25d2c9</br>**注意：务必创建时自定义UUID码**|
...
|服务器地址|自选ip（如：`uicdn.cf`或`icook.tw`）</br>应用程序名.herokuapp.com|
|端口|443|
|密码|96d61823-2492-45a6-87bb-40ba1e25d2c9</br>**注意：务必创建时自定义UUID码**|
|传输协议|ws|
